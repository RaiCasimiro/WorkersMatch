...
<body>
    ...
    <div class="container1">
        ...
        <div class="pergunta">
            <h3 class="pergunta-titulo" onclick="troca( this )">
                Quais são os requisitos para se candidatar a uma vaga?
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="seta"
                    viewBox="0 0 16 16">
                    <path
        ...
        <div class="pergunta">
            ...
            <div class="box">
                <p class="resposta">
                    ...
                    currículo e a partir daí, a empresa fará o processo seletivo da maneira que preferir.
                </p>
            </div>
        </div>
        ...
        <div class="pergunta">
            ...
            <div class="box">
                <p class="resposta">Sim, na aba de "Minhas vagas" você poderá salvar vagas para uma análise
                    posteriormente.</p>
            </div>
        </div>
    ...
    <script src="{{ asset('perguntas.js') }}"></script>
