...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <h3>MENU</h3>
    <ul>
      <li><a href="/wm/perfil">Perfil</a></li>
          ...
          <div class="card active">
            ...
            <div class="card-body">
              ...
              <p class="card-text">O candidato ideal terá sólidos conhecimentos em desenvolvimento de software, especialmente
                ...
                de backend</p>
              <a class="lerMais" href="" id="lerMaisLink"><span>Ler mais</span></a>
              <div id="lerMaisModal" class="modal">
                <div class="modal-content">
                  <h1>Descrição da vaga</h1>
                  <span class="close">Fechar Informações</span>
                </div>
              </div>
            </div>
          </div>
